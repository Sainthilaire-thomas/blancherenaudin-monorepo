...
function SearchContent() {
  ...
  // Rechercher au chargement si query pr�sente
  useEffect(() => {
    if (initialQuery) {
      searchProducts()
    }
  ...
  // Rechercher quand les filtres changent (SEULEMENT si on a d�j� fait une recherche)
  useEffect(() => {
  ...
  // Clear search et retour � l'�tat initial
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[1920px] mx-auto px-6 py-12 sm:px-10 lg:px-16">
        ...
        {/* Contenu : Avant recherche OU R�sultats */}
        {!hasSearched || !searchQuery.trim() ? (
          /* �tat initial - Quick access (style Jacquemus) */
